...
if use_ccs:
    from datasets.hico_ccs import build as build_dataset
    # from datasets.vcoco_ccs import build as build_dataset
else:
...
elif model_name == 'cdn-dn':
    from models import build_dn_model as build_model
    from dn_engine import train_one_epoch, evaluate_hoi
elif model_name == 'cdn-dn-m':
    from models import build_dn_m_model as build_model
    from dn_engine import train_one_epoch, evaluate_hoi
elif model_name == 'doq':
    from models import build_doq_model as build_model
    from dn_engine import train_one_epoch, evaluate_hoi
elif model_name == 'gen':
    from models import build_gen_model as build_model
    from engine import train_one_epoch, evaluate_hoi
elif model_name == 'gen-dn':
    from models import build_gen_dn_model as build_model
    from dn_engine import train_one_epoch, evaluate_hoi
elif model_name == 'gen-dn-m':
    from models import build_gen_dn_m_model as build_model
    from dn_engine import train_one_epoch, evaluate_hoi
...
def main(args):
    ...
    if args.resume:
        ...
        if not args.eval and 'optimizer' in checkpoint and 'lr_scheduler' in checkpoint and 'epoch' in checkpoint:
            ...
            if lr_scheduler.step_size != args.lr_drop:
                ...
                if lr_scheduler.last_epoch == args.lr_drop:
                    lr_scheduler.last_epoch = args.lr_drop - 1
                    lr_scheduler.step()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        elif args.freeze_mode == 0 and epoch >= args.lr_drop and epoch % 1 != 0:  ## eval every 2 epoch after lr_drop
            continue
